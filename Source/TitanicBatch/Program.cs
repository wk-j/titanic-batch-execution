...
namespace TitanicBatch {
    ...
    class Program {
        ...
        // Replace this with your Azure Storage Container name

        static string apiKey = System.Environment.GetEnvironmentVariable("az_titanic_key");
